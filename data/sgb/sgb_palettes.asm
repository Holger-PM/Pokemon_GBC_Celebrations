...
ENDC
IF DEF(_GREEN)
	RGB 31,31,31, 30,30,17, 21,00,04, 10,29,03  ; PAL_LOGO1
ENDC	
	RGB 31,31,31, 28,24,00, 18,19,18, 03,09,19 ; PAL_LOGO2
	RGB 31,31,31, 29,25,15, 04,17,31, 00,00,00 ; PAL_EXP
...
IF GEN_2_GRAPHICS
	RGB 31,31,31, 15,24,21, 15,20,11, 00,00,00 ; PAL_BULBASAUR
	...
	RGB 31,31,31, 30,27,13, 19,08,02, 00,00,00 ; PAL_PIDGEY
