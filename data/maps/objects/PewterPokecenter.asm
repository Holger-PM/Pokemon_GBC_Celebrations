...
PewterPokecenter_Object:
	...
	def_object_events
	object_event  4,  1, SPRITE_NURSE, STAY, DOWN, TEXT_PEWTERPOKECENTER_NURSE
	object_event 10,  6, SPRITE_GENTLEMAN, STAY, LEFT, TEXT_PEWTERPOKECENTER_GENTLEMAN
	object_event  2,  3, SPRITE_JIGGLYPUFF, STAY, DOWN, TEXT_PEWTERPOKECENTER_JIGGLYPUFF
