...
Route22OldRodHouse_TextPointers:
	def_text_pointers
	dw_const Route22OldRodHouseFishingGuruText, TEXT_ROUTE_22OLDRODHOUSE_FISHING_GURU
	dw_const Route22FishingEncounterPaperText, TEXT_ROUTE22_OLDRODHOUSE_FISHINGENCOUNTER_PAPER
...
Route22FishingEncounterPaperText:
	text_far _Route22FishingEncounterPaperText
	text_end